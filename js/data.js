const situations = [
    {
        ...
        digital: {
            ...
            practice: "Fact-checking en direct. Tu guides Emma sur Décodeurs ou AFP Factuel depuis son smartphone. Elle remonte aux sources primaires, repère les red flags.",
            why: "Tu travailles directement la compétence \"Évaluer l'information\" du référentiel européen : distinguer sources fiables/douteuses, vérifier la crédibilité, croiser les infos.",
            argument: "Sans accès immédiat au numérique, le fake reste dans les têtes jusqu'au prochain cours. Avec leur laptop, ils·elles développent le réflexe critique en temps réel."
        },
        analog: {
            competence: "1.2 - Évaluer l'information",
            status: "NON ACTIVÉE",
            ...
            timeLost: "24h de latence = 24h où la désinformation circule dans le groupe WhatsApp de classe. Et qui lit vraiment les photocopies ? La compétence DigComp d'évaluation critique reste en théorie, pas en pratique."
        }
    },
    {
        id: "1B",
        ...
        situation: "Projet 'Migrations' : les élèves doivent réunir 10 sources variées (articles, vidéos, podcasts, infographies). Comment ils s'organisent ?",
        digital: {
            competence: "1.1 - Naviguer, rechercher et filtrer l'information + 1.3 - Gérer l'information",
            status: "ACTIVÉES",
            domainDescription: "Savoir chercher, trier le vrai du faux, et organiser ce qu'on trouve. Bref : naviguer dans le déluge d'infos sans se noyer.",
            practice: "Chaque élève collecte, tague et partage dans un Padlet collaboratif. Tu vois en temps réel qui bloque, qui cartonne, qui part en hors-sujet.",
        ...
        analog: {
            ...
            status: "NON ACTIVÉES",
            domainDescription: "Savoir chercher, trier le vrai du faux, et organiser ce qu'on trouve. Bref : naviguer dans le déluge d'infos sans se noyer.",
            practice: "Impression massive, classeurs physiques, un élève rapporte tout chez lui... et perd le dossier dans le bus.",
    ...
    },
    {
        ...
        situation: "Groupe de 4 sur Baudelaire. Sarah fait tout, les autres font la sieste. Comment tu structures la collaboration pour éviter ça ?",
        digital: {
            ...
            practice: "Google Doc partagé avec suivi des contributions, chat Teams pour coordonner, Trello pour répartir les tâches.",
        ...
        analog: {
            ...
            practice: "Réunion physique, prise de notes sur feuille, \"on se voit demain\", personne ne se voit.",
            timeLost: "Qui a la version finale ? Mystère. Qui a bossé ? Encore plus mystérieux. Sarah fait tout quand même, en mode panique la veille. La compétence 2.4 du DigComp (collaboration numérique structurée) n'est jamais développée."
        }
    },
    {
        id: "2B",
        ...
        digital: {
            ...
            status: "ACTIVÉE",
            domainDescription: "Échanger, partager, bosser en équipe avec le numérique. Aussi : gérer son identité en ligne et savoir se comporter en citoyen·ne numérique sans être un troll.",
            practice: "Atelier express via Kahoot sur les traces numériques. Chacun·e découvre ce qui reste en ligne pour toujours.",
            ...
            argument: "L'apprentissage se fait dans l'instant, avec leur outil. Pas un cours magistral qui passe au-dessus de la tête, mais une expérience concrète : \"Ah merde, ça reste vraiment ?\""
        },
        analog: {
            competence: "2.5 - Comportement numérique",
            status: "NON ACTIVÉE",
    ...
    },
    {
        ...
        situation: "Mohamed présente 'La Première Guerre mondiale' : 47 slides, Comic Sans, texte copié-collé de Wikipédia ou de ChatGPT. Comment tu le fais évoluer ?",
        digital: {
        ...
        analog: {
            ...
            status: "NON ACTIVÉE",
            domainDescription: "Produire, remixer, coder. Du simple montage photo jusqu'à la programmation, en passant par les questions de droits d'auteur. Créer plutôt que consommer.",
            practice: "Tu distribues une grille d'évaluation papier avec plein de critères.",
            timeLost: "Mohamed lit les critères, hoche la tête... et ne sait toujours pas *comment* faire mieux. Il refait la même chose en 35 slides. La compétence 3.1 du DigComp (création numérique réfléchie) n'est jamais pratiquée."
        }
    },
    {
        id: "3B",
        ...
        digital: {
            ...
            status: "ACTIVÉES",
            domainDescription: "Produire, remixer, coder. Du simple montage photo jusqu'à la programmation, en passant par les questions de droits d'auteur. Créer plutôt que consommer.",
            practice: "Enregistrement sur Audacity ou Anchor, montage simple, export MP3. Tu héberges les podcasts sur un site sharepoint de classe.",
        ...
        analog: {
            ...
            status: "NON ACTIVÉES",
            domainDescription: "Produire, remixer, coder. Du simple montage photo jusqu'à la programmation, en passant par les questions de droits d'auteur. Créer plutôt que consommer.",
            practice: "Tu réserves la salle info 3 semaines à l'avance. 2 élèves par PC, bagarre pour le micro, la moitié n'a pas le temps de finir.",
            timeLost: "Ceux qui finissent doivent envoyer leur fichier par mail... qui se perd. Les autres abandonnent. Tu récupères 4 podcasts sur 24. Les compétences 3.1 et 3.4 du DigComp (création et logique de production) restent inaccessibles à la majorité."
        }
    },
    {
        id: "4A",
        ...
        digital: {
            ...
            practice: "Tu proposes un \"Digital Detox Challenge\" de 30 min via l'app Forest (tous·tes ensemble). Débriefing après : comment ils·elles se sentent sans notifs.",
        ...
        analog: {
            ...
            status: "NON ACTIVÉE",
            domainDescription: "Protéger ses données, ses appareils, sa santé mentale et la planète. Le numérique, c'est puissant... mais pas sans effets secondaires.",
            practice: "Tu confisques le smartphone. Sofia râle, tu passes pour le·a flic, elle recommence demain.",
    ...
    },
    {
        ...
        situation: "Un élève reçoit 'Votre compte scolaire expire. Cliquez ici.' Il clique et se fait hacker. Comment tu transformes ça en apprentissage ?",
        digital: {
    ...
    },
    {
        ...
        situation: "Tu es en plein cours filmé, le projecteur crashe. Les élèves attendent. Ta solution ?",
        digital: {
    ...
    },
    {
        ...
        situation: "Karim ne suit plus depuis 3 semaines. Il dit que 'les maths, c'est mort'. Comment tu le raccroches ?",
        digital: {
